				...
				<CommandList>
					...
					<CommandGroup heading="Links">
						...
						<CommandItem
							...
							onSelect={() => {
								runCommand(() => navigate('https://shadcnui-boilerplate.pages.dev/'))
							}}
						>
					...
					<CommandGroup heading="Language">
						{languages.map((language) => (
							<CommandItem key={language.value} value={language.value} onSelect={() => runCommand(() => changeLanguage(language.value))}>
